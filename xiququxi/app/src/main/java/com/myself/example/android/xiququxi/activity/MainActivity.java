...
import com.myself.example.android.xiququxi.fragment.CourseFragment;
import com.myself.example.android.xiququxi.fragment.ExercisesFragment;
import com.myself.example.android.xiququxi.fragment.MyinfoFragment;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                Toast.makeText(MainActivity.this, "再按一次退出戏剧趣析", Toast.LENGTH_SHORT).show();
